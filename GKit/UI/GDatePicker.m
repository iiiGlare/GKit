...
//        NSInteger year = [_picker selectedRowInComponent:[self componentForType:GDatePickerComponentTypeYear]]%_numberOfYears + _beginYear;
//        NSInteger month = [_picker selectedRowInComponent:[self componentForType:GDatePickerComponentTypeMonth]]%12 + 1;
//        NSInteger day = [_picker selectedRowInComponent:[self componentForType:GDatePickerComponentTypeDay]]%31 + 1;
//        
